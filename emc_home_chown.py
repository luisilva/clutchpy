...
def questiona():
	answer = raw_input ("Enter the user directory path your would like to fix ownership on (/n/<pi_lab>/Users): ")
	answer = answer.strip()
	return answer
...
if answerb == 1:
	for n in lsOutput.splitlines():
		...
		chowner = Popen(['chown', '-Rv', n, homeDirPath + '/' + n], stdout=PIPE, stderr=PIPE)
...
if len(errors) == 0:
	...
	print "Um so there were some errors, you may what to look into these directories: \n"
